...
#define Log_e(args...) Log_writter(__FILE__, __FUNCTION__, __LINE__, MQTT_ERROR, args)
#else
#define Log_d(args...) printk("")
#define Log_i(args...) printk("")
#define Log_w(args...) printk("")
#define Log_e(args...) printk("")
#endif
