 ...
 * MQTT 订阅报文默认参数
 */
 #define DEFAULT_SUB_PARAMS {QOS1, NULL, NULL}
 ...
 */
#ifdef AUTH_MODE_CERT
	#define DEFAULT_MQTTINIT_PARAMS { NULL, NULL, NULL, NULL, 8000, 240 * 1000, 0, 1, {0}}
#else
    #define DEFAULT_MQTTINIT_PARAMS { NULL, NULL, NULL, 8000, 240 * 1000, 1, 1, {0}}
#endif
