...
/* 产品名称的最大长度 */
#define MAX_SIZE_OF_PRODUCT_ID                                    	(32)

/* 设备ID的最大长度 */
#define MAX_SIZE_OF_DEVICE_NAME                                     (64)

/* MQTT消息发送buffer大小, 支持最大256*1024 */
#define QCLOUD_IOT_MQTT_TX_BUF_LEN                                  (300)

/* MQTT消息接收buffer大小, 支持最大256*1024 */
#define QCLOUD_IOT_MQTT_RX_BUF_LEN                                  (1152) // same to ATC_RESPBUFSIZE
...
/* MQTT连接域名 */
#define QCLOUD_IOT_MQTT_DIRECT_DOMAIN        						config.host

/* CoAP连接域名 */
#define QCLOUD_IOT_COAP_DEIRECT_DOMAIN								QCLOUD_IOT_MQTT_DIRECT_DOMAIN
