...
static int flash_stm32_check_status(struct device *dev)
{
	...
	return 0; /* resolve flash write error problem 2019-09-17 */
...
#if (!defined(CONFIG_SOC_SERIES_STM32F0X)) && (!defined(CONFIG_SOC_SERIES_STM32L1X))
...
static struct flash_stm32_priv flash_data = {
	...
	.regs = (struct stm32l1x_flash *) FLASH_DEV_BASE_ADDRESS,
#endif
};
